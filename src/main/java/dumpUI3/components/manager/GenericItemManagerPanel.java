...
import dumpUI3.components.globalslavepanel.GlobalSlavePanel;
import dumpUI3.components.itemslist.GenericItemsListPanel;
import dumpUI3.components.observer.SelectionObserver;
import dumpUI3.components.observer.SelectionObserverButton;
...
public abstract class GenericItemManagerPanel<E extends Comparable<E>> extends JPanel implements SelectionObserver {
  ...
  public abstract void removeAction(List<E> items);
  public abstract void moveToAction(List<E> items);
